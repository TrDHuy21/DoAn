...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250427053708_add_color_for_ProductDetail")]
    partial class add_color_for_ProductDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Enity.Brand", b =>
                {
                    b.HasOne("Domain.Enity.User", "CreatedByUser")
                        .WithMany("CreatedBrand")
                    ...
                    b.HasOne("Domain.Enity.User", "UpdatedByUser")
                        .WithMany("UpdatedBrand")
            ...
            modelBuilder.Entity("Domain.Enity.ProductAttribute", b =>
                {
                    ...
                    b.HasOne("Domain.Enity.User", "CreatedByUser")
                        .WithMany("CreatedProductAttribute")
                        .HasForeignKey("CreatedBy");

                    b.HasOne("Domain.Enity.User", "UpdatedByUser")
                        .WithMany("UpdatedProductAttribute")
                        .HasForeignKey("UpdatedBy");
            ...
            modelBuilder.Entity("Domain.Enity.User", b =>
                {
                    ...
                    b.Navigation("CreatedProductAttribute");

                    b.Navigation("CreatedProductDetail");
                    ...
                    b.Navigation("UpdatedBrand");

                    b.Navigation("UpdatedCategory");

                    b.Navigation("UpdatedProduct");

                    b.Navigation("UpdatedProductAttribute");

                    b.Navigation("UpdatedProductDetail");
